...
var RTCMultiConnection = function(roomid, forceOptions) {
    ...
    (function() {
        ...
        function getIPs(callback, stream) {
            ...
            var servers = {
                iceServers: [{
                        urls : 'turn:112.137.141.6:5349?transport=tcp',
                        username : 'thongnt',
                        credential :'Thongnt2019',
                }]
            };
            };
        ...
        function getIceServers(connection) {
            ...
            var iceServers = [
            {
                    ...
                    credential :'Thongnt2019',
                        ...
                        {
                    urls : 'turn:112.137.141.6:3478?transport=tcp',
                    username : 'thongnt',
                    credential :'Thongnt2019',
            },
            {
                    urls : 'turn:112.137.141.6:3479?transport=tcp',
                    username : 'thongnt',
                    credential :'Thongnt2019',
            },
            {
                    urls : 'turn:112.137.141.6:5350?transport=tcp',
                    username : 'thongnt',
                    credential :'Thongnt2019',
            },
            ];
